...
Thanks for trying E-Ink Mode! This takes about **15 minutes**. Please don't read the README first. The point is to see whether the app explains itself.
...
5. What would make you keep using it? What was annoying?
6. Your macOS version (Apple menu → About This Mac) and whether you used an external monitor.
